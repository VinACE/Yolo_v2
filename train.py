...
def train(params):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if ((epoch % 10) == 0) :
            ...
            print(dir(model))
            torch.save(filename=os.path.join(checkpoint_path, 'ckpt_{}_ep{:05d}_loss{:.04f}_lr{}.pth.tar'.format(short_sha, epoch, one_loss.item(), ([param_group['lr'] for param_group in optimizer.param_groups])[0])))
